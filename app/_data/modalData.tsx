    ...
    return (
        <>
            ...
            <span className="text-sm sm:text-base">
                ...
                the Bt exceeds 10nT. Strong values start at 20nT and we speak of a very strong total interplanetary magnetic field when values exceed
                30nT.
            </span>
            ...
            <div className="text-sm  " role="KP Index">
                <table className="text-xs sm:text-sm md:text-base">
                    <caption className="p-4">
                        <p className="text-sm sm:text-base text- underline underline-offset-4">Geomagnetic Storms</p>
                    </caption>
                    <thead>
                        <tr>
                            <th>Scale </th>
