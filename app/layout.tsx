        ...
        <html lang="en">
            ...
            <body className={quicksand.className}>
                ...
                <span className="text-[8px] text-stone-700  font-semibold image-creds ">
                    ...
                    <a href="https://pixabay.com/users/evamichalkova-1091520/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8465061">
                        Eva Michálková
                    </a>{" "}
                    from{" "}
                    <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8465061">Pixabay</a>
                </span>
            </body>
        </html>
    );
