    ...
    return (
        <nav className={cssClass} role="menu">
            <Link href="/" role="menu item" aria-label="Navigate to Dashboard ">
                <h2 className={`${linksClass} ${pathname === "/" ? "active font-[600] " : ""} hover:font-bold`}>DASHBOARD</h2>
            </Link>
            <Link href="/graphs" role="menu item" aria-label="Navigate to Graphs ">
                <h2 className={`${linksClass} ${pathname === "/graphs" ? "active font-[600]" : ""} hover:font-bold`}>GRAPHS</h2>
            </Link>
            <Link href="/weather" role="menu item" aria-label="Navigate to Weather ">
                <h2 className={`${linksClass} ${pathname === "/weather" ? "active font-[600]" : ""} hover:font-bold`}>WEATHER</h2>
            </Link>
            <Link href="/about" role="menu item" aria-label="Navigate to About section">
                <h2 className={`${linksClass} ${pathname === "/about" ? "active font-[600]" : ""} hover:font-bold`}>ABOUT</h2>
            </Link>
        </nav>
    );
}
